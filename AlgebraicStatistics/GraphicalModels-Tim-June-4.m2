...
newPackage(
     ...
     Certification => {
	  ...
	  "published code URI" => "http://j-sag.org/Volume5/myGraphicalModels.m2",
	  "repository code URI" => "http://github.com/Macaulay2/M2/blob/master/M2/Macaulay2/packages/myGraphicalModels.m2",
...
trekSeparation (MixedGraph,ZZ) := List => (g,k) -> (
    {42})
...
doc ///
  ...
  Caveat
     myGraphicalModels requires Graphs.m2. This package allows the user to create graphs whose vertices are labeled arbitrarily. 
     However, several functions in myGraphicalModels sort the vertices of the graph. Hence, graphs used as input to methods 
     in myGraphicalModels must have sortable vertex labels, e.g., all numbers or all letters. 
///;
...
uninstallPackage "myGraphicalModels"
restart
--installPackage("Graphs", UserMode=>true)
installPackage ("myGraphicalModels", RemakeAllDocumentation => true, UserMode=>true)
viewHelp myGraphicalModels
installPackage("myGraphicalModels",UserMode=>true,DebuggingMode => true)
installPackage ("myGraphicalModels", RemakeAllDocumentation => true, UserMode=>true)
installPackage("myGraphicalModels", RemakeAllDocumentation => true, UserMode=>true, DebuggingMode => true, FileName => "/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/myGraphicalModels/myGraphicalModels.m2")
installPackage("myGraphicalModels", RemakeAllDocumentation => true, UserMode=>true, DebuggingMode => true, FileName => "/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/myGraphicalModels/myGraphicalModels-Mike.m2")
installPackage("myGraphicalModels", RemakeAllDocumentation => true, UserMode=>true, DebuggingMode => true, FileName => "/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/myGraphicalModels/myGraphicalModels-old.m2")
----------------------
-- Parameterization -- ????????????????????????????????????????????????????????????????????????
---------------------- 
...
restart
installPackage "myGraphicalModels"
check "myGraphicalModels"

restart
printWidth=75;
needsPackage "myGraphicalModels";
...
restart
installPackage ("myGraphicalModels",FileName=>"/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/myGraphicalModels/myGraphicalModels.m2", RemakeAllDocumentation => true) 

 restart
 loadPackage("myGraphicalModels", FileName => "/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/myGraphicalModels/myGraphicalModels.m2")
 f = () -> (
   R := gaussianRing G;
   gaussianVanishingIdeal R)
 G = graph({{a,b},{b,c},{c,d},{a,d}})
