...
newPackage(
     ...
     Certification => {
	  ...
	  "published code URI" => "http://j-sag.org/Volume5/GraphicalModelsMultiTrek.m2",
	  "repository code URI" => "http://github.com/Macaulay2/M2/blob/master/M2/Macaulay2/packages/GraphicalModelsMultiTrek.m2",
...
doc ///
  ...
  Caveat
     GraphicalModelsMultiTrek requires Graphs.m2. This package allows the user to create graphs whose vertices are labeled arbitrarily. 
     However, several functions in GraphicalModelsMultiTrek sort the vertices of the graph. Hence, graphs used as input to methods 
     in GraphicalModelsMultiTrek must have sortable vertex labels, e.g., all numbers or all letters. 
///;
...
uninstallPackage "GraphicalModelsMultiTrek"
restart
--installPackage("Graphs", UserMode=>true)
installPackage ("GraphicalModelsMultiTrek", RemakeAllDocumentation => true, UserMode=>true)
viewHelp GraphicalModelsMultiTrek
installPackage("GraphicalModelsMultiTrek",UserMode=>true,DebuggingMode => true)
installPackage ("GraphicalModelsMultiTrek", RemakeAllDocumentation => true, UserMode=>true)
installPackage("GraphicalModelsMultiTrek", RemakeAllDocumentation => true, UserMode=>true, DebuggingMode => true, FileName => "/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/GraphicalModelsMultiTrek/GraphicalModelsMultiTrek.m2")
installPackage("GraphicalModelsMultiTrek", RemakeAllDocumentation => true, UserMode=>true, DebuggingMode => true, FileName => "/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/GraphicalModelsMultiTrek/GraphicalModelsMultiTrek-Mike.m2")
installPackage("GraphicalModelsMultiTrek", RemakeAllDocumentation => true, UserMode=>true, DebuggingMode => true, FileName => "/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/GraphicalModelsMultiTrek/GraphicalModelsMultiTrek-old.m2")
----------------------
-- Parameterization -- ????????????????????????????????????????????????????????????????????????
---------------------- 
...
restart
installPackage "GraphicalModelsMultiTrek"
check "GraphicalModelsMultiTrek"

restart
printWidth=75;
needsPackage "GraphicalModelsMultiTrek";
...
restart
installPackage ("GraphicalModelsMultiTrek",FileName=>"/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/GraphicalModelsMultiTrek/GraphicalModelsMultiTrek.m2", RemakeAllDocumentation => true) 

 restart
 loadPackage("GraphicalModelsMultiTrek", FileName => "/Users/lgp/Software/Macaulay2/Workshop-2014-Berkeley/GraphicalModelsMultiTrek/GraphicalModelsMultiTrek.m2")
 f = () -> (
   R := gaussianRing G;
   gaussianVanishingIdeal R)
 G = graph({{a,b},{b,c},{c,d},{a,d}})
