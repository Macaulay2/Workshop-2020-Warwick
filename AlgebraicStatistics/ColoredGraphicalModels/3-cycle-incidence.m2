...
minPrimesK=minimalPrimes K
Sigma=matrix{{sigma_11,sigma_12,sigma_13},{sigma_12,sigma_22,sigma_23},{sigma_13,sigma_23,sigma_33}}
detSigma=ideal det Sigma
(det Sigma)%minPrimesK_1
isSubset(detSigma,minPrimesK_1)
isSubset(minPrimesK_1,detSigma)
