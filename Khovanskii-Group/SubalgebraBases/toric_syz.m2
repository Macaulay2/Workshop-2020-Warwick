...
toricSyz(Subring, Matrix) := (subR, M) -> (
    ...
    -- notice how this consists of monomials and ans itself does not.
    -- This is because the substitution maps of subR and KA are different.
    -- ans = (KA#"PresRing"#"Substitution")(ans);
