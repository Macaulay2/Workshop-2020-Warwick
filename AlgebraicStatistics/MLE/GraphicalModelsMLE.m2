...
doc ///
    ...
    Description        
     Text
      ...
      continuous Gaussian graphical models associated to loopless mixed graphs(LMG).
      
      The main features of the package are the computation of the @TO sampleCovarianceMatrix@ of sample data, 
      the ideal generated by @TO scoreEquations@ of log-likelihood functions of continuous Gaussian graphical models,
      the @TO MLdegree@ of such model and the MLE for the covariance or concentration matrix via @TO solverMLE@.
     ...
     Text
      {\bf Applications of @TO solverMLE@:} positive definite matrix completion
     Text      
